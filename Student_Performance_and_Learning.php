...
<head>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-page-breadcrumb-area">
            <h2>Student Performance and Learning Outcomes</h2>
            <ol class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <li class="active">Student Performance and Learning Outcomes</li>
            </ol>
          </div>
        </div>
      </div>
  ...
  <div class="row">
                ...
                <div class="col-sm-9 p-5 sep-navtab">
                    <h2 class="text-center">Student Performance and Learning Outcomes</h2>
                    <table class="table table-striped table-hover table-bordered text-center">
                        <tbody>
                            ...
                            <tr>
                                <td>1</td>
                                <td>Student Performance and Learning Outcomes</td>
                                <td><strong><a style="color: #3366ff;" href="files/Students performance and Learning outcomes1.pdf" target="_blank" rel="noopener noreferrer">View</a></strong></td>
                            </tr>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Student Performance and Learning Outcomes</td>
                                <td><strong><a style="color: #3366ff;" href="files/Student Performance and Learning Out comes2.pdf" target="_blank" rel="noopener noreferrer">View</a></strong></td>
                            </tr>
...
<tr>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Student Performance and Learning Outcomes</td>
                                <td><strong><a style="color: #3366ff;" href="files/Student Performance and Learning Out comes1.pdf" target="_blank" rel="noopener noreferrer">View</a></strong></td>
                            </tr>
