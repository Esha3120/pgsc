<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">PGSC</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Banana SoftInfoTech</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="teacher_add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Teacher</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="teacher_info.php" class="nav-link">
                  <i class="far  fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="recentnews.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Recent news info</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="about_content.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>about us Content</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="principal_message.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
