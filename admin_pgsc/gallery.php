...
if (isset($_REQUEST['btnsubmit'])) {
  ...
  if (
    ...
    move_uploaded_file(
      ...
      "images/gallery/small/" . $_FILES['txt_img']['name']
    );
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $i++ ?></td>
                    <td><?php echo $row['g_heading'] ?></td>
                    <td><img src="images/gallery/small/<?php echo $row['g_img'] ?>" height="50px" width="50px"></td>
                    <td>
                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-default<?php echo $row['g_id'] ?>"><i class="fa fa-pencil
"> Edit</i>
                      </button>
                      <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-delete<?php echo $row['g_id'] ?>"><i class="fa fa-trash
"> Delete</i>
                      </button>
                    </td>
                    <div class="modal fade" id="modal-delete<?php echo $row['g_id'] ?>">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form method="post" class="">
                              <input type="hidden" name="did" value="<?php echo $row['g_id']; ?>">
                          </div>
          ...
          <div class="modal fade" id="modal-default<?php echo $row['g_id'] ?>">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <form method="post" enctype="multipart/form-data" class="swalDefaultInfo">
                    <input type="hidden" name="eid" value="<?php echo $row['g_id'] ?>">
                    <div class="form-group">
                      <label>Heading</label>
                      <textarea class="form-control" required="" name="txt_heading"><?php echo $row['g_heading'] ?></textarea>
                    </div>
                    <div class="form-group">
                      <label>Active</label>
                      <?php
