  ...
  if ($_FILES['txt_file']['type'] == "") {
    ...
    $q = "update news 
       set  n_title='$title',
            ...
            where n_id='$uid'
            ";
    move_uploaded_file($_FILES['txt_file']['tmp_name'], "../downloads/" . $file);
  }
  mysqli_query($con, $q);
  header("location:news.php");
}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><button class="btn btn-info" id="show">Add News</button></h1>
            </div>
            <div class="col-sm-6">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $row['n_des'] ?></td>
                    <td><embed src="./down0loads/<?php echo $row['n_file'] ?>" height="50px" width="50px"></td>
                    <td>

                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-default<?php echo $row['n_id'] ?>"><i class="fa fa-pencil
"> Edit</i>
                      </button>
                      <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-delete<?php echo $row['n_id'] ?>"><i class="fa fa-trash
"> Delete</i>
                      </button>
                    </td>
                    <div class="modal fade" id="modal-delete<?php echo $row['n_id'] ?>">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form method="post" class="">
                              <input type="hidden" name="did" value="<?php echo $row['n_id']; ?>">
                          </div>
          ...
          <div class="modal fade" id="modal-default<?php echo $row['n_id'] ?>">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <form method="post" enctype="multipart/form-data" class="swalDefaultInfo">
                    <input type="hidden" name="eid" value="<?php echo $row['n_id'] ?>">
                    <div class="form-group">
                      <label>Title</label>
                      <textarea class="form-control" required="" name="txt_title"><?php echo $row['n_title'] ?></textarea>
                    </div>
                    <div class="form-group">
                      <label>Description</label>
                      <textarea type="text" class="form-control" name="txt_des" required=""><?php echo $row['n_des'] ?></textarea>
                    </div>
                    <div class="form-group">
                      <label>File</label>
