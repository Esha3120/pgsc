        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="about-trust.php">Faculty</a></li>
                <li><a href="principal-message.php">Activity</a></li>
                <li><a href="principal-message.php">Events</a></li>
                <li><a href="principal-message.php">Student's Acheivement</a></li>
                <li><a href="principal-message.php">Sports</a></li>
                <li><a href="principal-message.php">Extracuricullar Activities</a></li>
              </ul>
            </li>
            <li class="dropdown">
